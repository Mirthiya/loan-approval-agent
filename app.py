...
def check_fraud(app, all_apps_df):
    ...
    # Only flag identical scores if the sheet actually had 3 separate bureau columns.
    # If there was only 1 credit score column, cs1==cs2==cs3 is expected — not fraud.
